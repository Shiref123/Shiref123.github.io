...
function cumulative() {
  var cumoldgpa = parseFloat(document.getElementById("cumoldgpa").value);
  var cumoldunit = parseFloat(document.getElementById("cumoldunit").value);
  var cumnewgpa = parseFloat(document.getElementById("cumnewgpa").value);
  var cumnewunit = parseFloat(document.getElementById("cumnewunit").value);
